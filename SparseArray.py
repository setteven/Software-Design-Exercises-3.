...
class SparseArray(object):
    ...
    #to string method to support the print and display operations
    def __str__(self):
        return str(self.L)

#declare and initialize the SparseArray
sa = SparseArray(5)
#add tuple to the array signifying index and value in the spare array
sa[0] = (12, "some")
sa[1] = (21, "more")
sa[2] = (51, "values")
sa[3] = (76, "are")
